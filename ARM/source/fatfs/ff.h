...
FRESULT f_read (FIL* fp, unsigned char * buff, UINT btr, UINT* br);			/* Read data from a file */
FRESULT f_write (FIL* fp, unsigned char * buff, UINT btw, UINT* bw);	/* Write data to a file */
